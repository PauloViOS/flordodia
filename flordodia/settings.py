"""
Django settings for flordodia project.
...
WSGI_APPLICATION = 'flordodia.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './flordodia.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
